...
public class ArrCustomer {
 ...
 Scanner sc= new Scanner(System.in); 
 double X;
 System.out.print("Jumlah: ");X=sc.nextDouble(); 
 while (X<=0 || X>a[i].saldo || X>10000000){
    System.out.print("Jumlah Pengambilan harus lebih dari 0 dan kurang dari saldo atau kurang dari 10.000.000\n");
    System.out.print("Jumlah: ");X=sc.nextDouble();
 }
 ...
 void Penambahan(int i){
 Scanner sc= new Scanner(System.in); 
 double X;
 System.out.print("Jumlah: ");X=sc.nextDouble();
 while (X<=0 || X>30000000){
    System.out.print("Jumlah Penambahan harus lebih dari 0 dan kurang dari 30.000.000\n");
    System.out.print("Jumlah: ");X=sc.nextDouble();
 }
 a[i].saldo=a[i].saldo+X;
 ...
 System.out.print("Pilihan anda ");int X=sc.nextInt();
 return X;
 }
 ...
 case 4: A.Penambahan(active);break; 
